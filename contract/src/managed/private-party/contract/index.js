...
(function (PartyState) {
  PartyState[PartyState['NOT_STARTED'] = 0] = 'NOT_STARTED';
  PartyState[PartyState['READY'] = 1] = 'READY';
  PartyState[PartyState['STARTED'] = 2] = 'STARTED';
  PartyState[PartyState['DOORS_CLOSED'] = 3] = 'DOORS_CLOSED';
  PartyState[PartyState['FEES_CLAIMED'] = 4] = 'FEES_CLAIMED';
...
class _Either_1 {
  alignment() {
    return _descriptor_5.alignment().concat(_descriptor_9.alignment().concat(_descriptor_1.alignment()));
  }
  fromValue(value_0) {
    return {
      is_left: _descriptor_5.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_5.toValue(value_0.is_left).concat(_descriptor_9.toValue(value_0.left).concat(_descriptor_1.toValue(value_0.right)));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      rsvp: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`rsvp: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const _address_0 = args_1[1];
        const _secret_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('rsvp',
        ...
        const result_0 = this._rsvp_0(context,
                                      partialProofData,
                                      _address_0,
                                      _secret_0);
      ...
      startParty: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`startParty: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('startParty',
                                     'argument 1 (as invoked from Typescript)',
                                     'private-party.compact line 46 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(_secret_0.buffer instanceof ArrayBuffer && _secret_0.BYTES_PER_ELEMENT === 1 && _secret_0.length === 32)) {
        ...
        const result_0 = this._startParty_0(context, partialProofData, _secret_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      checkIn: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('checkIn',
                                     'argument 1 (as invoked from Typescript)',
                                     'private-party.compact line 55 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(address_0).concat(_descriptor_0.toValue(_secret_0)),
            alignment: _descriptor_1.alignment().concat(_descriptor_0.alignment())
          },
          output: undefined,
          publicTranscript: [],
      ...
      closeEntry: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`closeEntry: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const _secret_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('closeEntry',
                                     'argument 1 (as invoked from Typescript)',
        ...
        const result_0 = this._closeEntry_0(context, partialProofData, _secret_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      claimFees: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`claimFees: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const address_0 = args_1[1];
        const _secret_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('claimFees',
                                     'argument 1 (as invoked from Typescript)',
        ...
        const result_0 = this._claimFees_0(context,
                                           partialProofData,
                                           address_0,
                                           _secret_0);
        partialProofData.output = { value: [], alignment: [] };
    ...
    this.impureCircuits = {
      rsvp: this.circuits.rsvp,
      startParty: this.circuits.startParty,
      checkIn: this.circuits.checkIn,
      closeEntry: this.circuits.closeEntry,
      claimFees: this.circuits.claimFees
    };
  ...
  initialState(...args_0) {
    ...
    if (!(typeof(partySize_0) === 'bigint' && partySize_0 >= 0n && partySize_0 <= 65535n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'private-party.compact line 19 char 1',
                                 'Uint<0..65536>',
                                 partySize_0)
    }
    ...
    state_0.setOperation('rsvp', new __compactRuntime.ContractOperation());
    state_0.setOperation('startParty', new __compactRuntime.ContractOperation());
    state_0.setOperation('checkIn', new __compactRuntime.ContractOperation());
    state_0.setOperation('closeEntry', new __compactRuntime.ContractOperation());
    state_0.setOperation('claimFees', new __compactRuntime.ContractOperation());
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.assert(partySize_0 > 0n,
                            'The party size must be greater than zero');
    __compactRuntime.assert(fee_0 > 0n, 'Fee must be greater than zero');
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_11.toValue(2n),
                                                                                              alignment: _descriptor_11.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_4.toValue(fee_0),
                                                                                              alignment: _descriptor_4.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _rsvp_0(context, partialProofData, _address_0, _secret_0) {
    const pubKey_0 = this._getDappPublicKey_0(_secret_0);
    __compactRuntime.assert(!this._equal_1(pubKey_0,
                                           _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                     ...
                                                                                                     [
                                                                                                      ...
                                                                                                      { popeq: { cached: false,
                                                                                                                 result: undefined } }]).value)),
                            'Organizer cannot RSVP to the party');
                             ...
                             _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       ...
                                                                                       [
                                                                                        ...
                                                                                        { popeq: { cached: false,
                                                                                                   result: undefined } }]).value)),
                            'The list is full');
    const commitHash_0 = this._commitAddress_0(_secret_0, _address_0.bytes);
                                                                                                 ...
                                                                                                 path: [
                                                                                                        { tag: 'value',
                                                                                                          value: { value: _descriptor_11.toValue(4n),
                                                                                                                   alignment: _descriptor_11.alignment() } }] } },
                                                                                        { push: { storage: false,
                                                                                                  value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(commitHash_0),
                                                                                                                                               alignment: _descriptor_0.alignment() }).encode() } },
                                                                                        'member',
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
  ...
  _startParty_0(context, partialProofData, _secret_0) {
    const pubKey_0 = this._getDappPublicKey_0(_secret_0);
    __compactRuntime.assert(this._equal_3(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value),
                                          pubKey_0),
                            'Only the organizer can start the party');
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
  ...
  _checkIn_0(context, partialProofData, address_0, _secret_0) {
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                            ...
                            ===
                            2,
                            'The party has not been started. Call the party police');
    let t_0;
    __compactRuntime.assert((t_0 = _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                             partialProofData,
                                                                                             [
    ...
    const commitHash_0 = this._commitAddress_0(_secret_0, address_0.bytes);
    __compactRuntime.assert(_descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                                                                                                 ...
                                                                                                 path: [
                                                                                                        { tag: 'value',
                                                                                                          value: { value: _descriptor_11.toValue(5n),
                                                                                                                   alignment: _descriptor_11.alignment() } }] } },
                                                                                        { push: { storage: false,
                                                                                                  value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(address_0),
  ...
  _closeEntry_0(context, partialProofData, _secret_0) {
    const pubKey_0 = this._getDappPublicKey_0(_secret_0);
    __compactRuntime.assert(this._equal_5(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value),
                                          pubKey_0),
                            'Only organizer can close the doors');
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
  ...
  _claimFees_0(context, partialProofData, address_0, _secret_0) {
    const pubKey_0 = this._getDappPublicKey_0(_secret_0);
    ...
    __compactRuntime.assert((t_0 = _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                             ...
                             t_0 > 0n),
                            'No fees to claim');
    const totalCollected_0 = _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
                                                                                        { idx: { cached: false,
  ...
  _commitAddress_0(_address_0, _secret_0) {
    return this._persistentCommit_0(_address_0, _secret_0);
  }
    ...
    checkedInParty: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(elem_0) === 'object' && elem_0.bytes.buffer instanceof ArrayBuffer && elem_0.bytes.BYTES_PER_ELEMENT === 1 && elem_0.bytes.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'private-party.compact line 17 char 1',
                                     'struct UserAddress<bytes: Bytes<32>>',
                                     elem_0)
        }
        return _descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
